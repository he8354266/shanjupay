...
public class PlatformParamController {
    ...
    public void bindPlatformForApp(@PathVariable("appId") String appId, @RequestParam String platformChannelCodes) {
    ...
    public void createPayChannelParam(@RequestBody PayChannelParamDTO payChannelParamDTO, @RequestParam Long merchantId) {
