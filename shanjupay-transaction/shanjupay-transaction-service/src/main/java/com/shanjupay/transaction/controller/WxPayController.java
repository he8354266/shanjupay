...
public class WxPayController {
    private static final String appID = "wxd2bf2dba2e86a8c7";
    private static final String mchID = "1502570431";
    private static final String appSecret = "cec1a9185ad435abe1bced4b93f7ef2e";
    private static final String key = "95fe355daca50f1ae82f0865c2ce87c8";
    //申请授权码地址
    private static final String wxOAuth2RequestUrl = "https://open.weixin.qq.com/connect/oauth2/authorize";
    //授权回调地址
    private static final String wxOAuth2CodeReturnUrl = "http://xfc.nat300.top/transaction/wx-oauth-code-return";
    ...
    public ModelAndView wxjspay(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        requestParam.put("out_trade_no", "10029293889");
